...
export const fetchGetContacts = createAsyncThunk('contact/fetchAll', async (token, thunkAPI) => {
  setAuthHeader(token);
...
export const fetchAddContact = createAsyncThunk('contact/addContact', async (arr, thunkAPI) => {
  try {
    const response = await axios.post('https://connections-api.herokuapp.com/contacts', {
      name: arr.name,
      number: arr.number,
    });
    return response.data;
...
export const fetchCreateUser = createAsyncThunk('login/addUser', async (arr, thunkAPI) => {
  try {
...
export const fetchLoginUser = createAsyncThunk('login/getUser', async (arr, thunkAPI) => {
  try {
